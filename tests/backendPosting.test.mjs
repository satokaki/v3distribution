...
const baseSeed = (quantity = 100) => ({
  Branch: [{ id: "PATRANG", code: "PTR", name: "Pusat", branch_type: "pusat", is_active: true }, { id: "MASTRIP", code: "MST", name: "Mastrip", branch_type: "cabang", is_active: true }],
...
const purchasePayload = (request = "PURCHASE-1") => ({ posting_request_id: request, branch_id: "PATRANG", date: "2026-08-14", payment_method: "kredit", due_date: "2026-08-28", supplier_id: "SUP-1", total: 100, items: [{ product_id: "IZZI", product_name: "IZZI Taro", sku: "IZZI-TARO", qty: 20, price: 5, subtotal: 100 }] });
